...
import { ref } from 'vue'
import { FolderOpen, Upload, Loader2, Music } from 'lucide-vue-next'
...
<template>
  <div
    class="relative rounded-3xl overflow-hidden cursor-pointer group transition-all"
    :class="isDragging ? 'ring-2 ring-violet-500 scale-[1.02]' : ''"
    style="background: linear-gradient(135deg, rgba(139, 92, 246, 0.08), rgba(59, 130, 246, 0.08)); border: 1px dashed rgba(255,255,255,0.1);"
  ...
  >
    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"
      style="background: radial-gradient(circle at 30% 20%, rgba(139,92,246,0.15), transparent 50%), radial-gradient(circle at 70% 80%, rgba(59,130,246,0.15), transparent 50%);"
    />
